import { buildWorktopData } from '../../utils/worktopPayload';
...
export default defineEventHandler(async (event) => {
  ...
  try {
    return await $fetch(`${config.strapiUrl}/api/worktops/${encodeURIComponent(documentId)}`, {
      method: 'PUT',
      headers: {
