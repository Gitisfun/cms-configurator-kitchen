import { buildPriceClassData } from '../../utils/priceClassPayload';
...
export default defineEventHandler(async (event) => {
  ...
  try {
    return await $fetch(`${config.strapiUrl}/api/price-classes/${encodeURIComponent(documentId)}`, {
      method: 'PUT',
      headers: {
